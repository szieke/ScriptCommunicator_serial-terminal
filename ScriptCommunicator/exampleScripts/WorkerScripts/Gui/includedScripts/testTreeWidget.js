...
treeItem3.setItemIcon(0, scriptThread.createAbsolutePath("icons/folder.gif"));
treeItem3.setText(1, "value6");
treeItem3.setItemIcon(1, scriptThread.createAbsolutePath("icons/browser.ico"));
...
treeItem4.setItemIcon(0, scriptThread.createAbsolutePath("icons/folder.gif"));
treeItem4.setText(1, "value8");
treeItem4.setItemIcon(1, scriptThread.createAbsolutePath("icons/browser.ico"));
