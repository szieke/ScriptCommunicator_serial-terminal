...
#ifndef SCRIPTTOOLBUTTON_H
#define SCRIPTTOOLBUTTON_H
...
class ScriptToolButton : public ScriptWidget
{
    Q_OBJECT
public:
    explicit ScriptToolButton(QToolButton* button, ScriptThread *scriptThread) :
        ScriptWidget(button, scriptThread, scriptThread->getScriptWindow()), m_button(button)
    {
        ...
        connect(m_button, SIGNAL(clicked()), this, SIGNAL(clickedSignal()));
        ...
        connect(this, SIGNAL(setTextSignal(QString,QToolButton*)), scriptThread->getScriptWindow(),
                SLOT(setTextSlot(QString,QToolButton*)), directConnectionType);
    ...
    {
        return ScriptWidget::getPublicScriptElements() + ";" + MainWindow::parseApiFile("ScriptToolButton.api");
    }
...
private:
    ///The wrapped tool button.
    QToolButton* m_button;
};

#endif // SCRIPTTOOLBUTTON_H
